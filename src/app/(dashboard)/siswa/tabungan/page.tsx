...
export default function SiswaTabunganPage() {
  ...
  const handleOpenRequestTarget = (acc: any) => {
    setTargetRequestForm({
      ...
      requestedAmount: String(acc.targetAmount || 1000000),
  ...
  return (
    <div className="space-y-6">
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-100 flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 rounded-xl text-xs font-bold transition"
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[95vh] flex flex-col overflow-hidden my-auto border border-slate-200 animate-in fade-in zoom-in-95 duration-200 print:border-none print:shadow-none print:rounded-none print:max-w-full print:max-h-none print:overflow-visible print:m-0 print:p-0">
            ...
            <div className="print:hidden p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-indigo-100 text-indigo-800 flex items-center justify-center font-bold shadow-2xs">
                  <BookOpen className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-sm font-extrabold text-slate-900">Rekening Koran / Buku Mutasi Siswa</h3>
                  <p className="text-[11px] text-slate-500 font-medium">
                    {activeAccount.accountNo} • {studentDisplayName} ({activeAccount.savingName})
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 bg-indigo-700 hover:bg-indigo-600 text-white rounded-xl text-xs font-bold transition shadow-xs"
                >
              ...
              <div className="printable-document bg-white p-6 sm:p-10 rounded-2xl border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-0 print:max-w-full font-sans text-slate-900">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] font-bold text-indigo-800 uppercase tracking-wide">
                    ...
                    <div className="text-right shrink-0 hidden sm:block">
                      <span className="text-[10px] font-extrabold uppercase px-2.5 py-1 rounded bg-indigo-50 text-indigo-800 border border-indigo-300">
                        E-STATEMENT SISWA
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 mb-5 pb-2 border-b border-dashed border-slate-300">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 font-medium">
                      Official Statement of Student Savings Account Ledger
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 p-4 bg-slate-50/80 rounded-2xl border border-slate-200 text-xs">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-slate-800">
                        Peserta Didik (Siswa PKBM Askara)
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-slate-500 font-medium">Jenis Program:</span>
                      <span className="font-bold text-indigo-800">{activeAccount.savingName}</span>
                    </div>
                    <div className="flex items-center justify-between">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between pt-1.5 border-t border-slate-300 bg-white p-2 rounded-xl border">
                      ...
                      <span className="font-black text-sm sm:text-base text-indigo-800">
                        ...
                        .map((t, idx) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="p-2 border-r border-slate-200 text-right font-mono font-black text-slate-950 bg-indigo-50/20">
                ...
                <div className="pt-2 border-t border-slate-200 grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs mt-6">
                  ...
                  <div className="space-y-1.5 text-[10px] text-slate-600 leading-relaxed">
                    ...
                    <p>1. Rekening koran ini merupakan dokumen resmi mutasi tabungan siswa PKBM Askara.</p>
                    <p>2. Seluruh setoran disinkronkan langsung dengan Manajemen & Bendahara Sekolah.</p>
                    <p>3. Apabila ada pertanyaan atau ketidaksesuaian saldo, segera hubungi Tata Usaha PKBM Askara.</p>
                  </div>

                  {/* Pengesahan Tanda Tangan */}
                  <div className="flex justify-between sm:justify-end gap-10 text-center text-xs">
                    <div>
                      <p className="text-[11px] text-slate-500 mb-14">Peserta Didik / Penabung,</p>
                      <p className="font-bold text-slate-900 border-b border-slate-400 pb-0.5">
                        {studentDisplayName}
                      </p>
                      <p className="text-[10px] text-slate-500">Siswa PKBM Askara</p>
                    </div>
                    <div>
      ...
      {/* ============================================================ */}
      {/* MODAL AJUKAN PERUBAHAN TARGET TABUNGAN                       */}
      {/* ============================================================ */}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/70 backdrop-blur-sm p-4 overflow-y-auto print:hidden">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden my-auto border border-slate-200 animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmitTargetRequest} className="p-5 space-y-4 text-xs">
              <div className="p-3 bg-blue-50/60 border border-blue-200 rounded-xl text-[11px] text-blue-900 leading-relaxed flex items-start gap-2">
                <Info className="w-4 h-4 text-blue-600 shrink-0 mt-0.5" />
                <span>
                  Pengajuan perubahan target dana memerlukan peninjauan dan persetujuan dari <strong>Bendahara Lembaga</strong>. Setelah disetujui, target tabungan akan otomatis diperbarui.
                </span>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-300 rounded-xl px-3 py-2 text-xs font-black text-emerald-800 focus:ring-2 focus:ring-blue-600 bg-emerald-50/20 focus:bg-white transition"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Contoh: Menambah target dana untuk biaya study tour tambahan / Penyesuaian kemampuan menabung bulanan..."
                  required
                />
              </div>
