      ...
      <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 space-y-8 shadow-sm text-slate-800">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* EMAIL AKTIF ORANG TUA (SUMBER LOGIN AKUN ORANG TUA) */}
            <div className="sm:col-span-2 p-4 bg-indigo-50/80 border border-indigo-200/90 rounded-2xl space-y-2">
              <div className="flex items-center gap-2 text-indigo-950 font-bold text-xs">
                <Mail className="w-4 h-4 text-indigo-700 shrink-0" />
                <span>
                  Email Aktif Orang Tua / Wali (Kredensial Login Akun Orang Tua) <span className="text-rose-500">*</span>
                </span>
              </div>
              <input
                type="email"
                ...
                className="w-full bg-white border border-indigo-200 rounded-xl px-3.5 py-2.5 text-xs text-indigo-950 font-bold focus:border-indigo-600 focus:ring-2 focus:ring-indigo-200 shadow-2xs placeholder:text-slate-400"
                required
              />
              <p className="text-[11px] text-indigo-800 flex items-center gap-1.5 leading-relaxed">
                <ShieldCheck className="w-3.5 h-3.5 text-indigo-600 shrink-0" />
                <span>
                  Sistem akan otomatis membuatkan akun resmi terpisah untuk Orang Tua/Wali menggunakan email ini untuk memantau presensi, tugas, nilai rapor, dan SPP/keuangan anak.
                </span>
              </p>
            </div>
          </div>
