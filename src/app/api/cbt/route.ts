...
export async function GET(req: NextRequest) {
  ...
  // Seed default assessments and questions if empty
  ...
  if (count === 0) {
    ...
    if (defaultTeacher && defaultClass && defaultSubject) {
      ...
      const ass1 = await db.assessment.create({
        data: {
          title: "Penilaian Tengah Semester (PTS) Ganjil - Matematika",
          type: "PTS",
          durationMinutes: 60,
          passingScore: 75,
          startTime: now,
          ...
          questions: {
            create: [
              {
                questionText: "Diketahui persamaan linear 2x + 3y = 12 dan x - y = 1. Berapakah nilai dari x + y?",
                questionType: "MULTIPLE_CHOICE",
                optionsJson: JSON.stringify(["A. 3", "B. 4", "C. 5", "D. 6"]),
                correctOption: "C",
                points: 50,
              },
              {
                questionText: "Sebuah matriks ordo 2x2 memiliki determinan sama dengan nol. Matriks tersebut disebut sebagai matriks...",
                questionType: "MULTIPLE_CHOICE",
                optionsJson: JSON.stringify(["A. Singular", "B. Diagonal", "C. Identitas", "D. Skalar"]),
                correctOption: "A",
                points: 50,
              },
            ],
      ...
      await db.assessment.create({
        data: {
          title: "Kuis Harian: Logika Matematika & Himpunan",
          type: "UH",
          durationMinutes: 30,
          passingScore: 70,
          startTime: now,
          ...
          questions: {
            create: [
              {
                questionText: "Ingkaran dari pernyataan 'Semua warga belajar rajin belajar' adalah...",
                questionType: "MULTIPLE_CHOICE",
                optionsJson: JSON.stringify([
                  "A. Semua warga belajar tidak rajin belajar",
                  "B. Ada warga belajar yang tidak rajin belajar",
                  "C. Tidak ada warga belajar yang rajin",
                  "D. Beberapa warga belajar rajin belajar",
                ]),
                correctOption: "B",
                points: 100,
              },
